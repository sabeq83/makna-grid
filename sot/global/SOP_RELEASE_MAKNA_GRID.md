# 📜 Standard Operating Procedure (SOP): Update Versi & Automatic Git Push — MAKNA Grid

**Target Repository**: `https://github.com/sabeq83/makna-grid.git`  
**Nama Projek**: `makna-grid`  
...
Setiap kali Anda (AI Agent / Developer) selesai melakukan perbaikan bug, refaktorisasi, atau penambahan fitur di `makna-grid` dan verifikasi berhasil:
...
- [ ] Git commit dan Tag rilis (`vX.Y.Z`) telah berhasil terunggah di repository `https://github.com/sabeq83/makna-grid.git`.
- [ ] Skrip `node scripts/test-cluster-health.js` berjalan hijau (Clean Pass).

---
*SOP ini resmi berlaku untuk projek `makna-grid`.*
