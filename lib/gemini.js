...
export async function getGeminiModel(apiKey = null) {
  ...
  return makeModelResilient(model, key, 'gemini-2.5-flash', apiKey !== null);
}
...
export async function generateWithVideo(fileUri, mimeType, prompt, apiKey = null) {
  ...
  const resilientModel = makeModelResilient(model, key, 'gemini-2.5-flash', apiKey !== null);
...
export async function testGeminiConnection(apiKey) {
  try {
    ...
    const resilientModel = makeModelResilient(model, apiKey, 'gemini-2.5-flash', true);
