...
/**
 * Audit Voiceover Script & Caption for TikTok Shop Compliance (Poller & Worker Alias)
 */
export async function auditScriptForTikTok(voiceoverText = '', captionText = '') {
  ...
  return {
    ...
    notes: hasBlockers ? 'Terdeteksi frasa sensitif kebijakan TikTok Shop' : 'Naskah bersih dari klaim terlarang'
  };
}
