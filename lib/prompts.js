...
Return ONLY valid JSON (no markdown code blocks, no explanation). Use this exact structure:
{
  ...
  ${dynamicPromptFields}
  "social_media_package": {
    "caption": "Single Universal Caption (terdiri dari Hook menarik, Value delivery, CTA universal, dan Hashtags relevan). In ${targetLanguageLabel}. MANDATORY: Caption dan Hashtags DILARANG KERAS memuat kata 'detox', 'detoks', 'usus kotor', 'melunturkan lemak', atau 'tanpa efek samping'. Gunakan hashtags edukatif aman seperti #PencernaanLancar #KesehatanPencernaan #GayaHidupSehat #TehHerbal."
  }
}
