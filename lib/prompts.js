...
- CONTOH BENAR: (Masalah: Susah BAB. Produk: Teko Kaca 5 in 1) -> "Biar pencernaan lancar, aku mulai rutin nyeduh air lemon hangat tiap pagi. Nah, biar seduhannya aman dan sekalian buat sekeluarga, aku selalu pakai [Nama Teko] ini karena kapasitasnya besar dan kacanya tahan panas."
...
Return ONLY valid JSON (no markdown code blocks, no explanation). Use this exact structure:
{
  ...
  "voiceover": [
    ...
    {
      "scene": ${targetClips},
      "narration": "Naskah audio default untuk klip terakhir.",
  ...
  ${dynamicPromptFields}
  "tiktok_caption": "Caption TikTok dengan hashtag relevan. In ${targetLanguageLabel}.",
  "ig_caption": "Caption Instagram Reels dengan CTA. In ${targetLanguageLabel}.",
  "yt_title": "Judul clickbait jujur YouTube Shorts. In ${targetLanguageLabel}.",
  "yt_desc": "Deskripsi YouTube Shorts ramah SEO. In ${targetLanguageLabel}."
}
