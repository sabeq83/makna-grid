...
const newDbPath = path.join(process.cwd(), 'data', 'makna_grid.db');
...
async function migrateProducts() {
  ...
  console.log(`✅ Successfully migrated ${insertedCount} products to MAKNA Grid database!`);

  // 3. Copy image assets from _maknagen to _makna-grid
