...
async function deployStaging() {
  ...
  const remoteScript = `
    ...
    PORT=4010 nohup /home/sabeqmursyid/.local/bin/node apps/api/server.js < /dev/null > backend-api.log 2>&1 &
    PORT=3010 nohup /home/sabeqmursyid/.local/bin/node node_modules/next/dist/bin/next start -H 0.0.0.0 -p 3010 < /dev/null > gateway.log 2>&1 &
