...
async function deployNode1() {
  ...
  const remoteScript = `
    ...
    echo "================================================================"
    echo "📱 ENVIRONMENT 1: PRODUCTION GATEWAY (Port 3000 & 4000)"
    echo "================================================================"
    ...
    echo "================================================================"
    echo "🧪 ENVIRONMENT 2: STAGING GATEWAY (Port 3010 & 4010)"
    echo "================================================================"
    ...
    echo "================================================================"
    echo "🎉 Node 1 Services Deployment (Production & Staging) Complete!"
    echo "================================================================"
  `;
