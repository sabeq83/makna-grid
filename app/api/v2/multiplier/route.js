...
export async function GET() {
  try {
    const tasks = getMultiplierTasks();
    const isSchedulerActive = getSetting('multiplier_scheduler_active') !== 'false';
...
export async function PATCH(request) {
  try {
    ...
    if (schedulerActive !== undefined) {
      setSetting('multiplier_scheduler_active', schedulerActive ? 'true' : 'false');
