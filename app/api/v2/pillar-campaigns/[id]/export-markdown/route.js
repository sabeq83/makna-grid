...
export async function POST(request, { params }) {
  try {
    ...
    if (storageProvider === 'nextcloud') {
      ...
      const baseFolder = campaign.nextcloud_parent_folder || getSetting('nextcloud_target_folder') || '/MAKNA_Video_Generations';
      ...
      updatePillarCampaign(id, { target_markdown_url: uploadResult.fileUrl });
      ...
      updatePillarCampaign(id, { target_markdown_url: uploadResult.driveUrl });
      ...
      if (!targetSpreadsheetId) {
        try {
          ...
          updatePillarCampaign(id, { target_spreadsheet_id: targetSpreadsheetId });
