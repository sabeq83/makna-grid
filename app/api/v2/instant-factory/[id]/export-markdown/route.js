...
export async function POST(request, { params }) {
  try {
    ...
    if (storageProvider === 'nextcloud') {
      ...
      const targetFolder = getSetting('nextcloud_target_folder') || '/MAKNA_Video_Generations';
      ...
      updateInstantCampaign(id, { target_markdown_url: uploadResult.fileUrl });
      ...
      updateInstantCampaign(id, { target_markdown_url: uploadResult.driveUrl });
