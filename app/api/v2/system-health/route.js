...
export async function GET() {
  try {
    ...
    let keys = [];
    try {
      keys = db.prepare('SELECT id, key_name, is_active, tier FROM gemini_api_keys').all();
    } catch (_) {}
    ...
    const logs = listSystemAuditLogs(false);
