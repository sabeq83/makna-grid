...
export async function POST(req, { params }) {
  try {
    ...
    const updateTransaction = db.transaction(() => {
      ...
      const currentItem = db.prepare("SELECT t2i_images_json, new_video_plan_json, result_json FROM re_campaign_items WHERE id = ?").get(itemId);
