...
export async function GET() {
  try {
    const { queueStats, globalStats } = getJobReports();
    const { totalCapacity, totalUsed } = getApiKeyStats();
    ...
    const { activeReCampaigns, activeGlabsCampaigns } = getActiveCampaignsStats();
    ...
    const glabsTasks = listGlabsTasks(50, 0);
