...
export async function GET() {
  try {
    const isSchedulerActive = getSetting('strategic_campaigns_scheduler_active') !== 'false';
...
export async function POST(request) {
  try {
    ...
    setSetting('strategic_campaigns_scheduler_active', schedulerStatus ? 'true' : 'false');
