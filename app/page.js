...
export default function Dashboard() {
  ...
  const getStatusBadge = (status) => {
    ...
    return <span style={{ padding: '3px 10px', borderRadius: '8px', background: 'rgba(100, 116, 139, 0.18)', border: '1px solid #475569', color: '#9ca3af', fontSize: '11px', fontWeight: 600 }}>Not Published</span>;
  };
  ...
  return (
    <div className="layout-with-sidebar">
      ...
      <main className="main-content" style={{ padding: '32px 36px', background: '#0b0f19', minHeight: '100vh', color: '#f1f5f9' }}>
        <div style={{ maxWidth: '1380px', width: '100%', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px', flexWrap: 'wrap', gap: '16px' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <h1 style={{ fontSize: '26px', fontWeight: 800, color: '#ffffff', margin: 0, letterSpacing: '-0.03em' }}>
                  Dashboard
                </h1>
            ...
            <button
              onClick={fetchStats}
              style={{
                padding: '10px 18px', borderRadius: '12px', background: 'rgba(30, 41, 59, 0.8)', border: '1px solid rgba(255, 255, 255, 0.12)',
                color: '#cbd5e1', fontSize: '12px', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px', marginBottom: '24px' }}>
            ...
            <div style={{
              padding: '20px 22px', borderRadius: '16px', background: 'linear-gradient(145deg, rgba(15, 23, 42, 0.8) 0%, rgba(14, 116, 144, 0.15) 100%)',
            ...
            <div style={{
              padding: '20px 22px', borderRadius: '16px', background: 'linear-gradient(145deg, rgba(15, 23, 42, 0.8) 0%, rgba(16, 185, 129, 0.15) 100%)',
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '14px' }}>
                ...
                <span style={{ fontSize: '11px', color: '#94a3b8', fontWeight: 600 }}>OPC & Strategic</span>
              </div>
            </div>

            {/* Card 3: Products Catalog */}
            <div style={{
              padding: '20px 22px', borderRadius: '16px', background: 'linear-gradient(145deg, rgba(15, 23, 42, 0.8) 0%, rgba(245, 158, 11, 0.15) 100%)',
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: '14px' }}>
                ...
                <span style={{ fontSize: '11px', color: '#94a3b8', fontWeight: 600 }}>SKUs Active</span>
              </div>
            </div>

            {/* Card 4: Server Cluster Health */}
            <div style={{
              padding: '20px 22px', borderRadius: '16px', background: 'linear-gradient(145deg, rgba(15, 23, 42, 0.8) 0%, rgba(99, 102, 241, 0.15) 100%)',
          ...
          <div style={{ padding: '22px 24px', borderRadius: '18px', background: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.08)', marginBottom: '28px', boxShadow: '0 12px 40px rgba(0,0,0,0.4)', backdropFilter: 'blur(20px)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <span style={{ fontSize: '12px', color: '#cbd5e1', fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
              ...
              <Link
                ...
                style={{
                  ...
                  color: '#ffffff', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '14px',
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 800, color: '#ffffff' }}>Content Flow Hub</div>
              ...
              <Link
                ...
                style={{
                  padding: '14px 18px', borderRadius: '14px', background: 'rgba(30, 41, 59, 0.8)', border: '1px solid rgba(255, 255, 255, 0.1)',
                  color: '#f1f5f9', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '14px',
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 700, color: '#f1f5f9' }}>+ Content Plan</div>
                  <div style={{ fontSize: '11px', color: '#94a3b8' }}>Import & Ingest OPC</div>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 700, color: '#f1f5f9' }}>+ Kampanye RE</div>
                  <div style={{ fontSize: '11px', color: '#94a3b8' }}>Reverse Engineering</div>
                </div>
              </Link>
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 700, color: '#f1f5f9' }}>+ Kampanye OPC</div>
                  <div style={{ fontSize: '11px', color: '#94a3b8' }}>Organic Pillar Content</div>
                </div>
              </Link>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.8fr) minmax(0, 1fr)', gap: '20px', alignItems: 'start' }}>
            ...
            <div style={{ padding: '24px', borderRadius: '18px', background: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.08)', boxShadow: '0 12px 40px rgba(0,0,0,0.4)', backdropFilter: 'blur(20px)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <div>
                  <span style={{ fontSize: '15px', color: '#ffffff', fontWeight: 800, display: 'block' }}>
                    📱 5 Konten Siap Publish Terbaru
                  </span>
                  <span style={{ fontSize: '12px', color: '#94a3b8' }}>Terhubung langsung ke PostgreSQL Node 3</span>
                </div>
              ...
              {loading ? (
                <div style={{ color: '#94a3b8', fontSize: '13px', textAlign: 'center', padding: '32px 0' }}>Memuat data dari PostgreSQL Node 3...</div>
              ) : !stats?.recentItems || stats.recentItems.length === 0 ? (
                <div style={{ color: '#94a3b8', fontSize: '13px', textAlign: 'center', padding: '32px 0' }}>Belum ada konten di database.</div>
              ) : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {stats.recentItems.map((item) => (
                    <div
                      key={item.id}
                      style={{
                        padding: '14px 16px', borderRadius: '12px', background: 'rgba(11, 15, 25, 0.8)', border: '1px solid rgba(255, 255, 255, 0.06)',
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0, flex: 1 }}>
                        ...
                        <span style={{ fontSize: '13px', color: '#f8fafc', fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            ...
            <div style={{ padding: '24px', borderRadius: '18px', background: 'rgba(15, 23, 42, 0.75)', border: '1px solid rgba(255, 255, 255, 0.08)', boxShadow: '0 12px 40px rgba(0,0,0,0.4)', backdropFilter: 'blur(20px)' }}>
              <div>
                <span style={{ fontSize: '15px', color: '#ffffff', fontWeight: 800, display: 'block', marginBottom: '4px' }}>
                  📊 Progress Publikasi Platform
                </span>
                <span style={{ fontSize: '12px', color: '#94a3b8', display: 'block', marginBottom: '20px' }}>
                ...
                <div style={{ marginBottom: '18px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginBottom: '6px' }}>
                    ...
                    <span style={{ color: '#cbd5e1', fontWeight: 700 }}>{stats?.platformStats?.tiktokPct ?? 0}% Published</span>
                  </div>
                  <div style={{ height: '10px', background: 'rgba(30, 41, 59, 0.8)', borderRadius: '6px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
                ...
                <div style={{ marginBottom: '18px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginBottom: '6px' }}>
                    ...
                    <span style={{ color: '#cbd5e1', fontWeight: 700 }}>{stats?.platformStats?.fbPct ?? 0}% Published</span>
                  </div>
                  <div style={{ height: '10px', background: 'rgba(30, 41, 59, 0.8)', borderRadius: '6px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginBottom: '6px' }}>
                    ...
                    <span style={{ color: '#cbd5e1', fontWeight: 700 }}>{stats?.platformStats?.igPct ?? 0}% Published</span>
                  </div>
                  <div style={{ height: '10px', background: 'rgba(30, 41, 59, 0.8)', borderRadius: '6px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
              ...
              <div style={{ padding: '12px 14px', borderRadius: '12px', background: 'rgba(30, 41, 59, 0.4)', border: '1px solid rgba(255, 255, 255, 0.05)', fontSize: '11px', color: '#94a3b8', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span>💡</span>
