          ...
          {activeResult && (
            <div className="output-panel" style={{ marginTop: '32px' }}>
              ...
              {tab === 'captions' && (
                <div>
                  {(() => {
                    const universalCap = activeResult.caption || activeResult.universal_caption || (typeof activeResult.social_media_package === 'object' ? activeResult.social_media_package?.caption : '') || activeResult.tiktok_caption || activeResult.ig_caption || '';
                    return (
